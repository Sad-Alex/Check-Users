...
Веб приложение для проверки наличия пользователей операционной системы Windows. Для работы используется встроенный веб сервер Tomcat v7.0.57. Для получения списка пользователей используется консольная команда "net users".
